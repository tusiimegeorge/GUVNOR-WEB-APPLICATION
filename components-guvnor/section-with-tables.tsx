    ...
    <>
      {sectionsToRender.map((currentSection) => (
        <div key={currentSection.id} className="mb-8">
          ...
          <Card className="relative overflow-hidden min-h-[300px] p-6">
            {currentSection.background_image_url && (
              <div
                className="absolute inset-0 bg-cover bg-center opacity-30"
                style={{ backgroundImage: `url(${currentSection.background_image_url})` }}
              />
            )}
