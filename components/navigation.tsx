...
export function Navigation() {
  ...
  const navLinks = [
    ...
    { href: "/bookings", label: "Booking", icon: Table },
    { href: "/about-us", label: "Location", icon: MapPin },
  ...
  const adminLinks = hasAdminAccess ? [
    ...
    { href: "/admin/bookings", label: "Manage Bookings", icon: Table },
    { href: "/admin/location-content", label: "Location Settings", icon: MapPin },
  ] : []
